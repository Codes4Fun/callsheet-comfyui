...
def stale_hint(label):
    """True if the store holds ANY variations for this label — lets
    deferral messages distinguish 'not yet generated' from 'exists but
    no longer matches its edited definition'."""
